...
class Parser(object):
    def __init__(self):
        ...
        parser.add_argument('--lambda_cross', type=float, default=1, help='weight for cross loss')
    ...
    def parse_args(self):
        ...
        opt.img_dir=opt.img_dir+opt.attr1+opt.attr2
