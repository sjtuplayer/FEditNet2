...
class Parser(object):
    def __init__(self):
        ...
        # basic settings
        parser.add_argument('--attr1', type=str, required=True, help='experiment name')
        parser.add_argument('--attr2', type=str, required=True, help='experiment name')
        parser.add_argument('--attr3', type=str, required=True, help='experiment name')
        ...
        # dataset settings
        parser.add_argument('--img_dir', type=str, default='dataset/', help='path to training data')
        ...
        parser.add_argument('--img_size', type=int, default=256, help='image size for StyleGAN2')
        ...
        parser.add_argument('--stylegan_ckpt', type=str, default='checkpoints/ffhq/stylegan2_ffhq.pt', help='path to checkpoint of pretrained StyleGAN2')
        ...
        parser.add_argument('--lambda_decouple', type=float, default=100, help='weight for decouple loss')
        parser.add_argument('--lambda_cross', type=float, default=0, help='weight for cross loss')
    ...
    def print_opt(self, parser, save_flag=True):
        ...
        opt.name = opt.attr1 + '-' + opt.attr2 + '-' + opt.attr3
        ...
        # nce layers
        max_layer = 2 * int(log2(opt.img_size) - 2) + 2
        print('max_layer:', max_layer, opt.nce_layers)
    ...
    def parse_args(self):
        ...
        opt.img_dir = opt.img_dir + opt.attr1 + opt.attr2 + opt.attr3
