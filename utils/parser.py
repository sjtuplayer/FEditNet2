...
class Parser(object):
    def __init__(self):
        ...
        # dataset settings
        parser.add_argument('--img_dir', type=str, default='dataset/celeba-test/', help='path to training data')
        ...
        parser.add_argument('--lambda_id', type=float, default=5., help='weight for id loss')
    ...
    def parse_args(self):
        ...
        opt.img_dir=opt.img_dir+opt.name
