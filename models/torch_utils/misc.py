...
#----------------------------------------------------------------------------
# Symbolic assert.
# pytorch 1.6.0 does not support this function, use python assert instead
'''
try:
    ...
    for name, tensor in named_params_and_buffers(dst_module):
        ...
        if name in src_tensors:
            if tensor.requires_grad:
                tensor.data.copy_(src_tensors[name].data)
            else:
